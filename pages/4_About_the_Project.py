...
with st.expander("🛠️ System Architecture & Data Processing (Click to Expand)"):
    ...
    * **Adaptive Signal Smoothing:** GPS vertical error can create "phantom walls" (e.g., a 1m error over 5m creates a fake 20% gradient). 
        To fix this, the system applies **Savitzky–Golay Filtering**. Crucially, the **window size is dynamic**—it automatically adjusts based on the data density (points per km) of the uploaded file.
