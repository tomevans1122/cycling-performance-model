            ...
            if time_seconds == float('inf'):
                ...
                * **Result:** To match this predicted time, your **Normalized Power (NP)** on the road will likely need to be **5-10% higher** than the Average Power shown here.
                ...
                if duration_hours < 1.25:
                    st.info(
                        f"💧 **Strategy:** For this duration and intensity, aim for **{intake_rec}**.\n\n"
                        "**Why 0g?** Your body typically stores **300g to 500g** of glycogen. "
                        f"Since this ride only burns an estimated **{int(carbs_burned)}g**, "
                ...
                # CASE 2: Medium Rides (1h 15m - 2h 30m)
                    ...
                    st.info(
                        f"⛽️ **Strategy:** For this duration and intensity, aim for **{intake_rec}**.\n\n"
