        ...
        if st.button("🧬 Start Evolutionary Optimisation", type="primary", width="stretch"):
            ...
            if final_time != float('inf'):
                ...
                if duration_hours < 1.25:
                    st.info(
                        f"💧 **Strategy:** For this duration and intensity, aim for **{opt_rec}**.\n\n"
                        "**Why 0g?** Your body typically stores **300g to 500g** of glycogen. "
                        f"Since this ride only burns an estimated **{int(opt_carbs)}g**, "
                ...
                # CASE 2: Medium Rides (1h 15m - 2h 30m)
                    ...
                    st.info(
                        f"⛽️ **Strategy:** For this duration and intensity, aim for **{opt_rec}**.\n\n"
                ...
                # CASE 4: Ultra Rides (> 4h)
                    ...
                    st.info(
                        ...
                        "the use of glucose and fructose mixes to maximise absorption while minimising gastrointestinal distress."
                    )
